...
\section{The Attiny Microcontroller}

??? what is the Attiny, what will it do for us ?

\section{Extension Memory layout}

??? what is the common register map seen by I2C reads and writes ?

\section{Extension Protocol Messages}

// ??? message layout 

\section{Extension common library}

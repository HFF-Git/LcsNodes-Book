...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1, transform shape]
        ...
        \node at (3.5, 2.5) {\includegraphics[page=1, width=0.4\textwidth]{./schematics/LCS-FP-MAIN-CTRL-Sketch.pdf}};

        \node at (11.5, 2.5) {\includegraphics[page=1, width=0.4\textwidth]{./schematics/LCS-FP-EXT-L-Sketch.pdf}};
        ...
        \draw[line width=1mm, gray!40, ->] (5, 3.3) -- (11, 3.3);
...
\unnumberedSection{I2C Addressing}
...
\unnumberedSection{Extension library}

// === becomes the channel interface ... much easier...
...
\unnumberedSection{Extension Board Driver}
...
\unnumberedSection{Utility for writing the NVM}
...
\unnumberedChapter{Smart Extension}

// ??? we actually only have smart extension now ....




??? describe a way to build extensions using a little micro controller. The Attiny family. 
...
\unnumberedSection{Extension common library}

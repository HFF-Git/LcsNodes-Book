\unnumberedChapter{Cab Control Extension Board}
...
// ??? design a board with an Attiny as the interface to UI elements...

// ??? or just use a 16 port i2c interface... e.g. MCP23017. Nice part is that we entirely control via I2C and can even have more than one such puppies on a controller ...

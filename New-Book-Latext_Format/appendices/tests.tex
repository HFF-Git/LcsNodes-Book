...
\section{New picture - Analog Subsystem}
...
\begin{tikzpicture}
    ...
    % Arrows from booster to tracks
    \draw[<->, ultra thick, line cap=round] (5, 5.75) -- (5, 7.5);
    \draw[<->, ultra thick, line cap=round] (8, 5.75) -- (8, 7.5);
    \draw[<->, ultra thick, line cap=round] (11, 5.75) -- (11, 7.5);
    \draw[<->, ultra thick, line cap=round] (14, 5.75) -- (14, 7.5);

...
\begin{longtable}{@{}|l|p{0.1\linewidth}|l|p{0.1\linewidth}|p{0.5\linewidth}@{}}
    \caption{Controller Attributes} \\
    \toprule
    ...
    \bottomrule
    \endlastfoot
    1 & \textbf{GND} & 2 & \textbf{GND} & Common ground pins. \\
    \midrule
    3 & \textbf{DCC-1} & 4 & \textbf{DCC-2} & The DCC "+" and "-" signal as generated by the DCC Signal Generator. These pins are typically driven by the base station generating the layout DCC signal.\\
    \midrule
    5 & \textbf{GND} & 6 & \textbf{GND} & Common ground pins. \\
    \midrule
    7 & \textbf{RST} & 8 & \textbf{EXT} & RST is reset line. Active Low. EXT is the external interrupt line which be raised from an extension board. Active low. \\
    \midrule
    9 & \textbf{ADC-0} & 10 & \textbf{ADC-1} & Analog input pins. The input is not protected. The analog voltage range is 0 to VCC. \\
    \midrule
    11 & \textbf{GND} & 12 & \textbf{GND} & Common ground pins. \\
    \midrule
    13 & \textbf{DIO-0} & 14 & \textbf{DIO-1} & Plain digital Pins, input or output. The pins are protected. \\
    \midrule
    15 & \textbf{DIO-2} & 16 & \textbf{DIO-3} & Plain digital Pins, input or output. The pins are protected. \\
    \midrule
    17 & \textbf{DIO-4} & 18 & \textbf{DIO-5} & Plain digital Pins, input or output. The pins are protected. \\
    \midrule
    19 & \textbf{DIO-6} & 20 & \textbf{DIO-7} & Plain digital Pins, input or output. The pins are protected. \\
    \midrule

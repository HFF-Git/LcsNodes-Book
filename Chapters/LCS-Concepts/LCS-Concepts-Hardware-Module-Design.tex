...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1, transform shape]
        ...
        \node at (3, 2.5) {\includegraphics[page=1, width=0.5\textwidth]{./Figures/LCS-FP-MAIN-CTRL-Sketch.pdf}};

        \node at (10.5, 2.5) {\includegraphics[page=1, width=0.5\textwidth]{./Figures/LCS-FP-EXT-L-R-Sketch.pdf}};

        \node at (3, 5) {\textbf{Main Controller}};
        \node at (10, 5) {\textbf{Extension Board}};
        \node at (3.5, 3.7) {Track Bus};
        \node at (3.5, 1.7) {Extension Bus};

        \draw[line width=1mm, gray!40, ->] (5,3.7) -- (15,3.7);
        \draw[line width=1mm, gray!40, ->] (5,1.7) -- (15,1.7);

...
The base station module firmware is divided into a couple of key software modules. The section that follow present a high level overview and review some of the design choices taken. The source files also contains an extensive documentation how this all works. 

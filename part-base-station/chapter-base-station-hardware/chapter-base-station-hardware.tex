...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=3, width=0.9\textwidth]{schematics/Schematic_LcsNodes-Base-Station-Board.pdf}
...
\unnumberedSection{LocoNet Interface}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=5, width=0.9\textwidth]{schematics/Schematic_LcsNodes-Base-Station-Board.pdf}

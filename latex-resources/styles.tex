...
\newenvironment{smallGapEnumerate}{
  \begin{enumerate}[itemsep=4pt, parsep=0pt, topsep=2pt, partopsep=0pt]
}{\end{enumerate}}


%--------------------------------------------------------------------------------
% Keywords to print in bold in a code snippet.
%
%--------------------------------------------------------------------------------
\lstdefinelanguage{RtLib}{
    language=C++,
    morekeywords={
        initRuntime,
        startRuntime,
        registerInitCallback,
        registerPfailCallback,
...
%--------------------------------------------------------------------------------
% Style for key concepts and keywords.
%
%--------------------------------------------------------------------------------
\newenvironment{tsDefinition}
{%
    \begin{tabular}{@{}p{5cm}p{\dimexpr\linewidth-5cm\relax}@{}}
}
{%
    \end{tabular}
}

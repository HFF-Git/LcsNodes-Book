...
A good example is a block controller with four independent blocks. Each
block should normally be represented by a separate port. The physical
...
port and how the internal channels, which represent the access to hardware, 
are organized.
...
This event driven approach also avoids unnecessary dependencies between nodes and

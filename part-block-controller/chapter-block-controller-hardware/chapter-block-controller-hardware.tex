...
\unnumberedSection{Overall hardware module design}
...
\unnumberedSection{Quad Block Controller}
...
\unnumberedSubSection{Main Controller}
...
\unnumberedSubSection{DCC Signal Input}
...
\unnumberedSubSection{H-Bridge Decoding Logic}
...
\unnumberedSubSection{Power Unit}
...
\unnumberedSubSection{Railcom Support}
...
\unnumberedSubSection{Power Supply and Connector}
...
\unnumberedSubSection{Quad Block Controller PCB}
...
\unnumberedSection{Dual Block Controller}

??? make it a MONO controller...
...
\unnumberedSubSection{Dual Power Unit}
...
\unnumberedSubSection{Dual RailCom Detect}
...
\unnumberedSubSection{Connector and Power Supply}
...
\unnumberedSubSection{Dual Block Controller PCB}
...
\unnumberedSubSection{Block Controller Firmware}
...
\unnumberedSection{H-Bridge control revised}

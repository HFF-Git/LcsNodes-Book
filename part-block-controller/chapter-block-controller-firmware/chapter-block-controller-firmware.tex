\unnumberedChapter{Block Controller Firmware}
...
\begin{center}
    \begin{tikzpicture}[scale=0.9, transform shape]
        ...
        \draw[decorate, decoration={brace, amplitude=8pt, mirror}, line width=2pt] (12,0) -- (12,5);
        \draw[decorate, decoration={brace, amplitude=8pt, mirror}, line width=2pt] (12,6) -- (12,8);
        \draw[decorate, decoration={brace, amplitude=8pt, mirror}, line width=2pt] (12,9) -- (12,11);
...
The block controller needs to manage the sessionId and cabId of the engine it currently hosts. We need both when we want to survive a power down. Then the session is lost. When the engine is still in the block, the block controller will request a session. ( think about it.... )

On emergency stop, the former target speed is saved. On restart, we can ramp up again to target speed.

\unnumberedSection{Block Controller Ports Overview}
...
\unnumberedSection{Section Port}
...
\unnumberedSection{H-Bridge Port}
...
\unnumberedSection{Turnout Port}
...
\unnumberedSection{Block Controller Node}
...
\unnumberedSection{Info, Control and Events}
...
\unnumberedSection{To think about}

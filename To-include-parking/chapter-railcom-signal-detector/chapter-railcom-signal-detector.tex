\unnumberedChapter{DCC and RailCom Signal Detector}

intro text ...

// ??? rather put to base station ?


\unnumberedSection{RailCom Signal Detector}
...
\unnumberedSection{DCC Signal Detector}

...
\unnumberedSection{Hardware Module}
...
A port is further divided into channels. Each port can support up to eight channels. A channel is smallest addressable unit in a layout. Examples are signals, turnout and track sections. The combination of node, port and channel form the unique address in a LCS system.

\unnumberedSection{Attributes}

...
The byte fields names in an LCS message are explained in greater detail when we discuss the runtime library. For this chapter, the term \texttt{nId} will refer to node and the term \texttt{pcId} to the port and channel identifier. A node/port/channel identifier is a 16-bit word which consists of the 8-bit nodeId, the 4-bit portId and the 4-bit channel Id. The term \texttt{sId} refers to a locomotive session. The remaining message field names, such as \texttt{UID} or \texttt{spDir} or \texttt{argN}are fairly self-explaining. All other names are fairly self explaining.
...
\begin{table}[ht!]
    ...
    \resizebox{0.9\textwidth}{!}{ 
        \begin{tabular}{|l|l|l|l|l|l|l|l|}
            ...
            \textbf{Opcode} & \textbf{Data1} & \textbf{Data2} & \textbf{Data3} & \textbf{Data4} & \textbf{Data5} & \textbf{Data6} & \textbf{Data7} \\
            \hline
            REQ-NID & nId & nUID-4 & nUID-3 & nUID-2 & nUID-1 & flags & \\
            REP-NID & nId & nUID-4 & nUID-3 & nUID-2 & nUID-1 & flags & \\
            SET-NID & nId & nUID-4 & nUID-3 & nUID-2 & nUID-1 & flags & \\
            NCOL    & nId & nUID-4 & nUID-3 & nUID-2 & nUID-1 & & \\
            \hline
        \end{tabular}
    }
\end{table}
...
??? shorten the messages, allow only one arg ?

??? add an err argument to REP ?
...
\begin{table}[ht!]
    ...
    \resizebox{0.9\textwidth}{!}{ 
        \begin{tabular}{|l|l|l|l|l|l|l|l|}
            ...
            \textbf{Opcode} & \textbf{Data1} & \textbf{Data2} & \textbf{Data3} & \textbf{Data4} & \textbf{Data5} & \textbf{Data6} & \textbf{Data7} \\
            \hline
            NODE-GET & nId & pcId & item & arg1-H & arg1-L & arg2-H & arg2-L \\
            NODE-SET & nId & pcId & item & val1-H & val1-L & val2-H & val2-L \\
            NODE-REQ & nId & pcId & item & arg1-H & arg1-L & arg2-H & arg2-L \\
            NODE-REP & nId & pcId & item & arg1-H & arg1-L & arg2-H & arg2-L \\
            \hline
        \end{tabular}
    }
\end{table}

??? these messages may go away completely and are replaced by a REQ call.
...
\begin{table}[ht!]
    ...
    \resizebox{0.9\textwidth}{!}{ 
        \begin{tabular}{|l|l|l|l|l|l|l|l|}
            ...
            \textbf{Opcode} & \textbf{Data1} & \textbf{Data2} & \textbf{Data3} & \textbf{Data4} & \textbf{Data5} & \textbf{Data6} & \textbf{Data7} \\
            \hline
            EVT-ON & nId & pcId & evId-H & evId-L & & & \\
            EVT-OFF & nId & pcId & evId-H & evId-L & & & \\
            EVT & nId & pcId & evId-H & evId-L & arg-H & arg-L & \\
            \hline
        \end{tabular}
    }
\end{table}

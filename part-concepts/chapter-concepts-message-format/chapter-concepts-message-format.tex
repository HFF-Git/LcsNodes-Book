...
\begin{table}[ht!]
    ...
    \resizebox{0.9\textwidth}{!}{ 
        \begin{tabular}{|l|l|l|l|l|l|l|l|}
            ...
            REP-NID & npId-H & npId-L & UID-4 & nUID-3 & nUID-2 & nUID-1 & flags \\
            SET-NID & npId-H & npId-L & UID-4 & nUID-3 & nUID-2 & nUID-1 & flags \\
            NCOL    & npId-H & npId-L & UID-4 & nUID-3 & nUID-2 & nUID-1 & \\
            \hline
        \end{tabular}
    }
\end{table}
...
\begin{table}[ht!]
    ...
    \resizebox{0.9\textwidth}{!}{ 
        \begin{tabular}{|l|l|l|l|l|l|l|l|}
            ...
            \textbf{Opcode} & \textbf{Data1} & \textbf{Data2} & \textbf{Data3} & \textbf{Data4} & \textbf{Data5} & \textbf{Data6} & \textbf{Data7} \\
            \hline
            NODE-GET & npId-H & npId-L & item & arg1-H & arg1-L & & \\
            NODE-SET & npId-H & npId-L & item & val1-H & val1-L & & \\
            NODE-REQ & npId-H & npId-L & item & arg1-H & arg1-L & arg2-H & arg2-L \\
            NODE-REP & npId-H & npId-L & item & arg1-H & arg1-L & & \\
            NODE-REP2 & npId-H & npId-L & item & arg1-H & arg1-L & arg2-H & arg2-L \\
            \hline
        \end{tabular}
    }
\end{table}
...
\begin{table}[ht!]
    ...
    \resizebox{0.9\textwidth}{!}{ 
        \begin{tabular}{|l|l|l|l|l|l|l|l|}
            ...
            EVT-OFF & pId-H & npId-L & evId-H & evId-L & & & \\

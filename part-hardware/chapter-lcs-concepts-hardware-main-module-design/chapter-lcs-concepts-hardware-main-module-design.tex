...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=1, scale=0.7]{./part-hardware/chapter-lcs-concepts-hardware-main-module-design/LCS-FP-MAIN-CTRL-Sketch.pdf}
...
\begin{longtable}{@{}|l|l|p{0.6\linewidth}|@{}}
    ...
    1 & GND & common ground. \\
    \midrule
    2 & SCL & The I2C SCL line. \\
    \midrule
    3 & GND & common ground. \\
    \midrule
    4 & SDA & The I2C SDA line. \\
    \midrule
    5 & VCC & The power line. 5V. \\
    \midrule
    6 & VCC & The power line. 5V. \\
\end{longtable}

Lines are carefully chosen top allow a 4-wire and a 6-wire cable.
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1, transform shape]
        ...
        \node at (3.5, 2.5) {\includegraphics[page=1, width=0.5\textwidth]{./part-hardware/chapter-lcs-concepts-hardware-main-module-design/LCS-FP-MAIN-CTRL-Sketch.pdf}};

        \node at (11.5, 2.5) {\includegraphics[page=1, width=0.5\textwidth]{./part-hardware/chapter-lcs-concepts-hardware-main-module-design/LCS-FP-EXT-L-Sketch.pdf}};

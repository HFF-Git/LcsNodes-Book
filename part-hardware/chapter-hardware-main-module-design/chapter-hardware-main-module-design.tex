...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=1, scale=0.7]{./schematics/LCS-FP-MAIN-CTRL-Sketch.pdf}
...
The external I2C line, called the I2C bus, is exposed to the extension boards as well as a connector next to the LCS bus. 
...
// ??? talk about the track power part ....
...
// ??? what to keep here vs. extension part ?
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1, transform shape]
        ...
        \node at (3.5, 2.5) {\includegraphics[page=1, width=0.5\textwidth]{./schematics/LCS-FP-MAIN-CTRL-Sketch.pdf}};

        \node at (11.5, 2.5) {\includegraphics[page=1, width=0.5\textwidth]{./schematics/LCS-FP-EXT-L-Sketch.pdf}};

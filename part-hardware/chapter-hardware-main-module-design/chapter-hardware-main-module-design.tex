...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1, transform shape]
        ...
        \node at (3.5, 2.5) {\includegraphics[page=1, scale=0.5]
				{./part-hardware/chapter-hardware-main-module-design/LCS-FP-MAIN-10X12-B.02.10.pdf}};

        \node at (11.5, 2.5) {\includegraphics[page=1, scale=0.5]
        ...
        \node at (3.5, 2.25) {Extension Bus};

        \draw[line width=1mm, gray!40, ->] (5,2.25) -- (11,2.25);

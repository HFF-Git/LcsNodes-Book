...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=1, transform shape]
        \useasboundingbox (0,0) rectangle (15,10);
        \draw[help lines, gray!50, dashed] (0,0) grid(15,10);
        ...
        \node at (3, 9.5) {\textbf{Main Controller Board}};
        \node at (11, 9.5) {\textbf{Extension Board}};
    	...
    	\draw[line width=0.5mm, gray!40, <->] (4,3) -- (4,3.25) -- (6.2,3.25) -- (6.2,3);

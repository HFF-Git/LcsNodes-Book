...
Another approach is to design a node controller board with extension boards that can be connected to it. In the remainder of this chapter, we will describe the main controller board and the extension concept. However, it is also perfectly all-right to design a hardware component with all the components integrated on one board. For a complex node such as the base station, this is a very reasonable solution. But first, let's look at the physical dimension of our boards.
	...
	\begin{tikzpicture}[scale=0.9, transform shape]
    	...
    	\node at (8,4) {
        	\includegraphics[page=1, scale=0.7]
				{./part-hardware/chapter-hardware-main-module-design/LCS-FP-MAIN-10X12-B.02.10.pdf}
    	};
...
The external I2C line, called the I2C bus, is exposed to the extension boards as well as a connector next to the LCS bus. As we will see in the part on extension boards, extension boards are accessed via the I2C bus. 
...
\begin{longtable}{@{}|p{0.1\linewidth}|p{0.1\linewidth}|p{0.1\linewidth}|p{0.1\linewidth}|p{0.4\linewidth}|@{}}
    ...
    \midrule
    3 & \textbf{O-1-1} & 4 & \textbf{O-1-2} & Track 2 \\
    \midrule
    5 & \textbf{O-2-1} & 6 & \textbf{O-2-2} & Track 3 \\
    \midrule
    7 & \textbf{O-3-1} & 8 & \textbf{O-3-2} & Track 4 \\
    \midrule
    \midrule
    \midrule
    1 & \textbf{GND} & 2 & \textbf{GND} & Ground \\
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=1, transform shape]
        ...
        \node at (3.5, 6.5) {\includegraphics[page=1, scale=0.5]
				{./part-hardware/chapter-hardware-main-module-design/LCS-FP-MAIN-10X12-B.02.10.pdf}};
				
		\node at (12, 7) {\includegraphics[page=1, scale=0.5]
				{./part-hardware/chapter-hardware-main-module-design/LCS-FP-EXT-10X12-B.02.10.pdf}};

        \node at (11.5, 6.5) {\includegraphics[page=1, scale=0.5]
				{./part-hardware/chapter-hardware-main-module-design/LCS-FP-EXT-10X12-B.02.10.pdf}};

        \node at (3, 10) {\textbf{Main Controller Board}};
        \node at (11, 10) {\textbf{Extension Board(s)}};
        
        \node at (3.5, 6.5) {Extension Bus};
        \draw[line width=1mm, gray!40, ->] (5,6.5) -- (11,6.5);
        
        \node at (13.5, 1.5) {\textbf{Socket Boards}};
        
        \node at (3.5, 1.5) {\includegraphics[page=1, scale=0.35,  angle=270]
				{./part-hardware/chapter-hardware-main-module-design/LCS-FP-SOCKET-5X8-B.01.00.pdf}};
				
		\node at (6.5, 1.5) {\includegraphics[page=1, scale=0.35,  angle=270]
				{./part-hardware/chapter-hardware-main-module-design/LCS-FP-SOCKET-5X8-B.01.00.pdf}};
				
		\node at (10.5, 1.5) {\includegraphics[page=1, scale=0.35,  angle=270]
				{./part-hardware/chapter-hardware-main-module-design/LCS-FP-SOCKET-5X8-B.01.00.pdf}};

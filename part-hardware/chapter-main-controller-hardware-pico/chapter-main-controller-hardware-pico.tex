...
??? structure: purpose in overall LCS hardware , 
...
??? explain them here in more detail 
...
??? I2C driver for extension bus to isolate and drive a longer distance...


??? talk about the mapping of PICO pins to extension connector pins. 

??? Should allow that function blocks such as SPI, UART, I2C, etc can be accessed.

\unnumberedSection{PICO Pin Mapping}

??? this is how the pins are actually mapped to the PICO HW pins ...

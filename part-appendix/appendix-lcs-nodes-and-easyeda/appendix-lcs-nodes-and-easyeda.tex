...
\begin{tikzpicture}[x=1cm, y=1cm, scale=0.7, transform shape]
    ...
    \node[  tsRectangle, 
            ...
            minimum height=12cm,  
            fill=white,
            anchor=south west] at (7, 3) {\rotatebox{90}{ EXT-OUT }};
            
    \node[font=\small] at (7.0-0.25,15+0.25) {40};
    \node[font=\small] at (8.0+0.25,15+0.25) {41};
    
    \node[font=\small] at (7.0-0.25,3-0.25) {98};
    \node[font=\small] at (8.0+0.25,3-0.25) {99};
            
    \node[  tsRectangle, 
            minimum width=1cm,
            minimum height=12cm,  
            fill=white,
            anchor=south west] at (11, 3) {\rotatebox{90}{ EXT-IN }};
            
    \node[font=\small] at (11.0-0.25,15+0.25) {41};
    \node[font=\small] at (12.0+0.25,15+0.25) {40};
    
    \node[font=\small] at (11.0-0.25,3-0.25) {99};
    \node[font=\small] at (12.0+0.25,3-0.25) {98};

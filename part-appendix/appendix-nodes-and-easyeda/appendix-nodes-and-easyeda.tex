...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=1, scale=0.7]{./part-appendix/appendix-nodes-and-easyeda/LCS-FP-MAIN-10X12-B.02.10.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=1, scale=0.7]{./part-appendix/appendix-nodes-and-easyeda/LCS-FP-EXT-10X12-B.02.10.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=1, scale=0.4]{./part-appendix/appendix-nodes-and-easyeda/Lcsnodes-PCB-Connector-Footprint-Pad-Numbers-B-02-10.pdf}

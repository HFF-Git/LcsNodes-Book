\unnumberedChapter{Inspiring work and links}
...
\begin{longtable}{|p{0.4\linewidth}|p{0.5\linewidth}|}
    %\caption{Organizations and Links}
    \toprule
    \textbf{Organization} & \textbf{Link} \\
    \midrule
    \endfirsthead
    \toprule
    \textbf{Organization} & \textbf{Link} \\
...
\begin{longtable}{|p{0.18\linewidth}|p{0.26\linewidth}|p{0.46\linewidth}|}
    ...
    \endfirsthead
    \toprule
    textbf{Tool} & \textbf{Link} & \textbf{Comment} \\
    \midrule
    \endhead
    \midrule
    \multicolumn{2}{r}{\textit{Continued on next page}} \\
